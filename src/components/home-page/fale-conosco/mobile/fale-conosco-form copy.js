...
import { FlexContainer, GridContainer } from "../../../styling/layouts"
...
const FaleConoscoForm = () => {
  ...
  return (
    <GridContainer gap="5px" rows=".10fr .10fr 1fr .10fr" stretchX h100>
      <Title as="h2" color="orange" weight="400" mt="10px">
        Deixa uma mensagem
      </Title>
      <Text variant="secondary" weight="300">
        Sua mensagem será enviada a um de nossos funcionários que entrará em
        contato com você o mais rápido possível. Fique olhando em seu e-mail.
      </Text>
